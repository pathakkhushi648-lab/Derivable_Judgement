...
This project focuses on the application of inferential statistical techniques to analyze healthcare-related data and derive meaningful conclusions from the dataset. The objective of the project is to understand how statistical analysis supports data-driven decision-making in healthcare research.
...
* Smoking status showed association with diabetes prevalence.
* BMI varied across different age groups.
* Positive correlation was observed between age and BMI.
* Statistical tests helped identify significant healthcare patterns.
* Visualizations improved interpretation of statistical results.
